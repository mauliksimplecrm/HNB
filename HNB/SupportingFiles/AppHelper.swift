...
//  HNB
//
//  Created by Maulik Vora on 21/06/23.
//
...
func replaceMiddleCharacter(of text: String, withCharacter character: String, offset: Int) -> String {
...
func convertDateToString(dateToConvert: Date? = nil) -> String{
...
func dialTheNumberAndSendResponseBackToWeb(phoneNumber: String, module: String, recordId: String, requestData: AnyObject){
    var backgroundTaskID: UIBackgroundTaskIdentifier?
    
    let number = phoneNumber.replacingOccurrences(of: " ", with: "")
    if let numberUrl = URL(string: "tel://" + number ){
        UIApplication.shared.open(numberUrl) { opened in
            if opened {
                backgroundTaskID = UIApplication.shared.beginBackgroundTask(withName: "CallObserver") {
